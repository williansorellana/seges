<x-app-layout>
    ...
    <div class="py-12" x-data="calendarApp()" x-init="init()">
        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                @foreach($rooms as $room)
                    <div
                        class="bg-white dark:bg-gray-800 overflow-hidden shadow-lg rounded-xl border border-gray-200 dark:border-gray-700 hover:shadow-2xl transition duration-300 flex flex-col">
                        <div class="h-48 w-full bg-gray-700 relative overflow-hidden group">
                            ...
                            <div class="absolute top-2 right-2">
                                <span
                                    class="px-2 py-1 text-xs font-bold rounded-full {{ $room->status === 'active' ? 'bg-green-500 text-white' : 'bg-red-500 text-white' }}">
                        ...
                        <div class="p-6 flex-1 flex flex-col">
                            <div class="flex justify-between items-start mb-2">
                                <div class="flex items-center">
                                    ...
                                    <button @click="openViewModal({{ $room }})"
                                        class="ml-2 text-gray-400 hover:text-blue-400 transition" title="Ver detalles">
                                ...
                                <div
                                    class="flex items-center text-sm text-gray-500 dark:text-gray-400 bg-gray-700/30 px-2 py-1 rounded">
            ...
            <div class="p-6 bg-gray-800 text-gray-100">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                    <div
                        ...
                        <template x-if="viewingRoom.image_path">
                            <img :src="'/storage/' + viewingRoom.image_path"
                    ...
                    <div class="space-y-4">
                        ...
                        <div>
                            ...
                            <span class="text-lg text-gray-200"
                                x-text="viewingRoom.location || 'No especificada'"></span>
                        </div>

                        <div>
                            <span class="block text-xs text-gray-400 uppercase tracking-widest">Descripción</span>
                            <p class="text-sm text-gray-300 mt-1 bg-gray-900/50 p-3 rounded border border-gray-700"
                                x-text="viewingRoom.description || 'Sin descripción'"></p>
                        </div>
                    </div>
                </div>
                ...
                <div class="mt-8 flex justify-end">
                    <button @click="$dispatch('close')"
                        class="bg-gray-700 text-white px-4 py-2 rounded hover:bg-gray-600 transition">Cerrar</button>
                </div>
            </div>
        </x-modal>
        ...
        <x-modal name="agenda-modal" :show="false" focusable>
            ...
            <div class="md:p-8 p-5 dark:bg-gray-800 bg-white rounded-t">
                ...
                <div class="px-4 flex items-center justify-between">
                    <span tabindex="0"
                        class="focus:outline-none text-base font-bold dark:text-gray-100 text-gray-800 capitalize"
                        x-text="monthNames[month] + ' ' + year"></span>
                    <div class="flex items-center">
                        <button aria-label="calendar backward" @click="prevMonth()"
                            class="focus:text-gray-400 hover:text-gray-400 text-gray-800 dark:text-gray-100 p-1">
                        ...
                        <button aria-label="calendar forward" @click="nextMonth()"
                            class="focus:text-gray-400 hover:text-gray-400 ml-3 text-gray-800 dark:text-gray-100 p-1">
                ...
                <div class="mt-8 border-t border-gray-700 pt-4" x-show="selectedDate">
                    <h4 class="text-sm font-bold text-gray-400 uppercase tracking-wider mb-3">
                        Ocupación: <span x-text="selectedDate + ' de ' + monthNames[month]"
                            class="text-white normal-case"></span>
                    </h4>
                    ...
                    <template x-if="dayEvents.length === 0">
                        <div
                            class="p-3 bg-green-900/20 border border-green-900 rounded text-center text-green-400 text-sm">
        ...
        <x-modal name="reservation-modal" :show="false" focusable>
            <div class="p-6 bg-gray-800 text-gray-100">
                <h2 class="text-lg font-bold mb-4">Reservar: <span x-text="selectedRoom.name"
                        class="text-blue-400"></span></h2>
                ...
                <form method="POST" action="{{ route('reservations.store') }}">
                    ...
                    <div class="grid gap-4">
                        ...
                        <div>
                            ...
                            <input type="text" name="purpose" required
                                class="w-full bg-gray-900 border-gray-700 rounded text-white"
                                placeholder="Ej: Reunión Cliente">
                        </div>
                        <div class="grid grid-cols-2 gap-4">
                            <div>
                    ...
                    <div class="mt-6 flex justify-end space-x-3">
                        <button type="button" @click="$dispatch('close')"
                            class="bg-gray-600 text-white px-4 py-2 rounded hover:bg-gray-500">Cancelar</button>
                        <button type="submit"
                            class="bg-blue-600 text-white px-4 py-2 rounded hover:bg-blue-500">Confirmar</button>
                    </div>
                </form>
            </div>
        </x-modal>
