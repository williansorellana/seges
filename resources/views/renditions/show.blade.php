        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-12 gap-8">
                ...
                <div class="lg:col-span-4 space-y-8" x-data="{ activePanel: 'main' }">
                    ...
                    <div class="flex gap-4">
                        <template x-if="activePanel === 'main'">
                            <div class="flex gap-4 w-full">
                                ...
                                <button type="button" @click="activePanel = 'signatures'" class="flex-1 py-3 px-4 bg-slate-900/50 hover:bg-slate-800/50 text-white rounded-xl text-xs font-black uppercase tracking-wider transition-all border border-slate-800/60 hover:border-slate-700/60 shadow-lg flex items-center justify-center gap-2 cursor-pointer">
                        ...
                        <template x-if="activePanel !== 'main'">
                            <button type="button" @click="activePanel = 'main'" class="w-full py-3 px-4 bg-slate-900/50 hover:bg-slate-800/50 text-white rounded-xl text-xs font-black uppercase tracking-wider transition-all border border-slate-800/60 hover:border-slate-700/60 shadow-lg flex items-center justify-center gap-2 cursor-pointer">
                    ...
                    <div x-show="activePanel === 'main'" class="bg-white dark:bg-[#1e293b] overflow-hidden shadow-2xl sm:rounded-2xl border border-gray-100 dark:border-slate-700/60 ring-1 ring-black/5 dark:ring-white/5 p-6 relative">
                        <div class="relative z-10">
