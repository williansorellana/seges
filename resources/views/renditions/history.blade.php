    ...
    <x-slot name="header">
        <div class="flex flex-col gap-1">
            ...
            <div class="flex items-center gap-2">
                <span class="px-2 py-0.5 bg-blue-500/10 text-blue-400 text-[10px] font-black uppercase tracking-widest rounded-md border border-blue-500/20">Historial</span>
                <span class="w-1 h-1 rounded-full bg-slate-700"></span>
                <span class="text-xs text-slate-400 font-bold uppercase tracking-tighter">Registros de Viajes y Gastos</span>
            </div>
        </div>
    </x-slot>
                ...
                <div class="flex gap-8">
                    ...
                    <a href="{{ request()->fullUrlWithQuery(['tab' => 'rendiciones', 'renditions_page' => 1]) }}"
                       class="pb-4 text-xs font-black uppercase tracking-widest relative transition-all duration-300 cursor-pointer flex items-center gap-2 group {{ $activeTab === 'rendiciones' ? 'text-indigo-400' : 'text-slate-400 hover:text-slate-200' }}">
                        <svg class="w-4 h-4 {{ $activeTab === 'rendiciones' ? 'text-indigo-400' : 'text-slate-500 group-hover:text-slate-400' }}" fill="none" stroke="currentColor" viewBox="0 0 24 24">
